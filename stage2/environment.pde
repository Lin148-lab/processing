...
/**
 * Team Member C: EnvironmentManager.pde
...
class EnvironmentManager {
  ...
  // Reset food (keep current environment temperature unchanged)
  void resetFoods() {
    foodList.clear();
    generateFoods(50);   // Regenerate 50 foods, maintain high-low ratio
  }

  // 【Team Member C】Environment selection screen
  ...
  // 【Team Member C】Select environment and generate food
  ...
  // 【Team Member C】Draw background and food
  void drawBackground() {
    if (currentEnvType == 0) {
  ...
  // 【Team Member C】Generate initial food
  ...
  // 【Team Member C】Dynamically refresh food
  void updateFoods() {
